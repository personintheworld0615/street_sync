              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "When you start a report and save it for later, it'll show up here.",
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return ReportListCard(
                  ...
                  pill: ReportListCard.displayPill(report, fallback: 'Draft'),
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => Updatething.fromDraft(report),
                      ),
                    );
                  },
                );
